...
{
    public ExpressionParser(TextReader input, Analyzer analyzer, ExpressionContext context) : base(
        new ExpressionTokenizer(input, context), analyzer)
    {
        CreatePatterns();
    }
    ...
    {
        var pattern = default(ProductionPattern);
        var alt = default(ProductionPatternAlternative);
        ...
        pattern = new ProductionPattern(Convert.ToInt32(ExpressionConstants.IN_TARGET_EXPRESSION),
            "InTargetExpression");
        alt = new ProductionPatternAlternative();
        ...
        pattern = new ProductionPattern(Convert.ToInt32(ExpressionConstants.IN_LIST_TARGET_EXPRESSION),
        ...
        pattern = new ProductionPattern(Convert.ToInt32(ExpressionConstants.MULTIPLICATIVE_EXPRESSION),
        ...
        pattern = new ProductionPattern(Convert.ToInt32(ExpressionConstants.MEMBER_ACCESS_EXPRESSION),
        ...
        pattern = new ProductionPattern(Convert.ToInt32(ExpressionConstants.MEMBER_FUNCTION_EXPRESSION),
        ...
        pattern = new ProductionPattern(Convert.ToInt32(ExpressionConstants.FIELD_PROPERTY_EXPRESSION),
        ...
        pattern = new ProductionPattern(Convert.ToInt32(ExpressionConstants.CAST_TYPE_EXPRESSION),
            "CastTypeExpression");
        alt = new ProductionPatternAlternative();
        alt.AddToken(Convert.ToInt32(ExpressionConstants.IDENTIFIER), 1, 1);
        ...
        pattern = new ProductionPattern(Convert.ToInt32(ExpressionConstants.FUNCTION_CALL_EXPRESSION),
        ...
        pattern = new ProductionPattern(Convert.ToInt32(ExpressionConstants.BOOLEAN_LITERAL_EXPRESSION),
